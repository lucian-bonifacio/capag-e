...
- Status: aguardando_homologacao
- Data: 2026-07-08
- Decisão do usuário: ajuste solicitado e executado.
- Observação: reenviada para homologação com layout preservado e ajuste restrito a inteligencia de resumo por hierarquia declarada da ECD, incluindo agregacao objetiva de saldos analiticos quando a sintetica estiver zerada.
